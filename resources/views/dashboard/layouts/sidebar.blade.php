        ...
        <div class="quixnav">
            <div class="quixnav-scroll">
                <ul class="metismenu" id="menu">
                   ...
                   @if (!Auth::user()->employees) <li><a href="{{route('employee.index')}}"><i class="icon icon-single-04"></i><span class="nav-text">Employees</span></a></li> @endif
                   @if (!Auth::user()->employees) <li><a href="{{route('client.index')}}"><i class="icon icon-single-04"></i><span class="nav-text">Clients</span></a></li> @endif



                    <li><a href="{{route('project.index')}}"><i class="icon icon-single-04"></i><span class="nav-text">Projects</span></a> </li>
                    @if (!Auth::user()->employees)<li><a href="{{ route('department.index') }}"><i class="icon icon-single-04"></i><span class="nav-text">Departments</span></a>
                    </li> @endif
                    @if (!Auth::user()->employees)   <li class="nav-label first text-white">HR</li>
                    <li><a href="{{route('expenses.index')}}"><i class="icon icon-single-04"></i><span class="nav-text">Expenses</span></a></li>@endif
